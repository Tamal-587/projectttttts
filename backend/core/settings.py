...
# easily switched to PostgreSQL via DATABASE_URL or POSTGRES_* environment variables.
DATABASES = {
    'default': {
...
# CORS configuration
CORS_ALLOW_ALL_ORIGINS = DEBUG  # For ease of dev when running frontend locally
